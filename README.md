...
| [36 · Apprendre à répartir un portefeuille](https://github.com/Guilou001/36-apprendre-portefeuille) | Apprendre à choisir les placements selon les frais et le degré de prudence de l’investisseur. Sur six fonds canadiens, le modèle ajuste le risque au degré de prudence demandé. Son avantage sur un mélange simple de portefeuilles reste incertain. |
| [37 · Ajouter des placements au portefeuille](https://github.com/Guilou001/37-grands-portefeuilles) | Étudier ce qui arrive quand les placements sont plus nombreux que les mois observés. La méthode de calcul change la réponse, et copier des placements peut modifier le résultat sans apporter d’information nouvelle. |
...
| [35 · Comprendre le désaccord des modèles](https://github.com/Guilou001/35-desaccord-obligations) | Mesurer ce que révèle le désaccord entre six prévisions obligataires. Il renseigne sur leurs erreurs, mais le pénaliser dégrade ici le portefeuille. Vérifier aussi les fourchettes d’incertitude sur les seules obligations retenues pour investir. |
| [38 · Apprendre des autres marchés pour le Canada](https://github.com/Guilou001/38-apprendre-au-canada) | Utiliser quatre marchés étrangers pour prévoir les rendements de stratégies sur actions canadiennes. Ajuster leur poids selon les erreurs récentes ne bat pas clairement un mélange fixe des apprentissages local et étranger. |
| [39 · Faire comparer les obligations par un modèle](https://github.com/Guilou001/39-attention-obligations) | Faire circuler l’information entre obligations en donnant le même poids à chaque émetteur. Cette règle résiste aux copies artificielles testées, sans démontrer une amélioration de la performance. |
...
## Autres façons de parcourir les projets

<details>
<summary>Par métier</summary>

Les projets sont rattachés à une famille de poste. Leur description complète figure plus haut.

| Métier | Projets |
|---|---|
| Gestion de portefeuille | [01 · Choisir une répartition](https://github.com/Guilou001/01-frontiere-efficiente) · [02 · Comprendre l’erreur d’estimation](https://github.com/Guilou001/02-erreur-estimation) · [03 · Gérer un portefeuille](https://github.com/Guilou001/03-gestion-portefeuille) · [12 · Préparer son épargne](https://github.com/Guilou001/12-plan-epargne) · [13 · Mesurer l’effet du dollar américain](https://github.com/Guilou001/13-couverture-de-change) · [14 · Expliquer la performance](https://github.com/Guilou001/14-attribution-performance) · [16 · Échanger des hausses futures contre un revenu](https://github.com/Guilou001/16-options-couvertes) · [23 · Comprendre les fonds à levier quotidien](https://github.com/Guilou001/23-fnb-levier-quotidien) · [36 · Apprendre à répartir un portefeuille](https://github.com/Guilou001/36-apprendre-portefeuille) · [37 · Ajouter des placements au portefeuille](https://github.com/Guilou001/37-grands-portefeuilles) |
| Finance quantitative | [04 · Mon mémoire de maîtrise de 2024](https://github.com/Guilou001/04-memoire-uqam-2024) · [05 · Reprendre la question du mémoire](https://github.com/Guilou001/05-memoire-2.0) · [08 · Choisir des actions au Canada](https://github.com/Guilou001/08-facteurs-canada) · [15 · Calculer le prix d’une option](https://github.com/Guilou001/15-valorisation-options) · [21 · Rejouer une stratégie minute par minute](https://github.com/Guilou001/21-vwap-intrajournalier) · [22 · Prévoir la dernière demi-heure](https://github.com/Guilou001/22-derniere-demi-heure) · [24 · Comparer deux sources de prix](https://github.com/Guilou001/24-vwap-iex-vs-consolide) · [34 · Tester des modèles plus complexes](https://github.com/Guilou001/34-complexite-utile) · [35 · Comprendre le désaccord des modèles](https://github.com/Guilou001/35-desaccord-obligations) · [38 · Apprendre des autres marchés pour le Canada](https://github.com/Guilou001/38-apprendre-au-canada) · [39 · Faire comparer les obligations par un modèle](https://github.com/Guilou001/39-attention-obligations) · [Laboratoire de recherche quantitative](https://github.com/Guilou001/quant-research-platform) · [Prévoir une action avec un réseau de neurones](https://github.com/Guilou001/uqam-transformer-actions) |
| Analyse financière | [09 · Évaluer le Canadien National](https://github.com/Guilou001/09-valorisation-entreprise) · [28 · Lire les comptes autrement](https://github.com/Guilou001/28-etats-financiers-reformules) · [29 · Comprendre la rentabilité des banques](https://github.com/Guilou001/29-rentabilite-des-banques) |
| Crédit | [10 · Étudier un dossier de crédit](https://github.com/Guilou001/10-credit-bancaire) · [27 · Mesurer le risque des gros emprunteurs](https://github.com/Guilou001/27-portefeuille-de-credit) |
| Gestion des risques | [06 · Prévoir les mauvaises journées de Bourse](https://github.com/Guilou001/06-risque-marche) · [25 · Traduire un scénario climatique en pertes de crédit](https://github.com/Guilou001/25-scenario-climatique-bsif) · [30 · Prévoir le capital contre les fraudes et les erreurs](https://github.com/Guilou001/30-risque-operationnel) · [32 · Mesurer le risque d’un échange d’intérêts](https://github.com/Guilou001/32-xva-swaps) |
| Assurance | [17 · Financer les rentes d’un assureur](https://github.com/Guilou001/17-alm-assurance-vie) · [26 · Prévoir la facture d’un assureur](https://github.com/Guilou001/26-provisionnement-iard) · [31 · Chiffrer une garantie de placement](https://github.com/Guilou001/31-fonds-distincts) |
| Économie | [07 · Estimer la croissance avant sa publication](https://github.com/Guilou001/07-nowcast-pib-canada) · [11 · Lire les taux d’intérêt](https://github.com/Guilou001/11-courbe-des-taux) · [18 · Distinguer l’inflation durable des à-coups](https://github.com/Guilou001/18-inflation-fondamentale) · [Comprendre les cycles de l’économie canadienne](https://github.com/Guilou001/uqam-cycle-economique-canada) · [Comparer neuf modèles sur sept jeux de données](https://github.com/Guilou001/uqam-apprentissage-sept-bases) · [Prévoir le chômage américain](https://github.com/Guilou001/uqam-prevision-facteurs) · [Étudier les effets des taux et des dépenses publiques](https://github.com/Guilou001/uqam-svar-monetaire-budgetaire) · [Vérifier un modèle de croissance](https://github.com/Guilou001/uqam-croissance-capital-humain) |

</details>

<details>
<summary>Dans l’ordre de lecture</summary>

Les numéros suivent l’ordre d’ajout au parcours. Les travaux universitaires et les outils communs sont présentés séparément plus haut.

| Projet | Question étudiée |
|---|---|
| [01 · Choisir une répartition](https://github.com/Guilou001/01-frontiere-efficiente) | Comparer une répartition calculée à une somme égale dans chaque fonds. |
| [02 · Comprendre l’erreur d’estimation](https://github.com/Guilou001/02-erreur-estimation) | Vérifier si des calculs de placement battent une répartition égale. |
| [03 · Gérer un portefeuille](https://github.com/Guilou001/03-gestion-portefeuille) | Suivre un plan de placement sur des fonds canadiens et expliquer ses résultats. |
| [04 · Mon mémoire de maîtrise de 2024](https://github.com/Guilou001/04-memoire-uqam-2024) | Reproduire un travail sur la prévision des rendements d’actions canadiennes et américaines. |
| [05 · Reprendre la question du mémoire](https://github.com/Guilou001/05-memoire-2.0) | Mieux séparer l’apprentissage des tests et déduire les frais de transaction. |
| [06 · Prévoir les mauvaises journées de Bourse](https://github.com/Guilou001/06-risque-marche) | Comparer six façons d’annoncer une limite de perte quotidienne, puis compter les jours où elle est dépassée. |
| [07 · Estimer la croissance avant sa publication](https://github.com/Guilou001/07-nowcast-pib-canada) | Prévoir la croissance du trimestre en cours à partir de données mensuelles. |
| [08 · Choisir des actions au Canada](https://github.com/Guilou001/08-facteurs-canada) | Tester des règles comme acheter les actions qui ont récemment monté ou celles jugées peu chères par rapport aux comptes de l’entreprise. |
| [09 · Évaluer le Canadien National](https://github.com/Guilou001/09-valorisation-entreprise) | Relier le prix d’une action à l’argent que l’entreprise pourrait générer. |
| [10 · Étudier un dossier de crédit](https://github.com/Guilou001/10-credit-bancaire) | Estimer le risque qu’un emprunteur ne rembourse pas. |
| [11 · Lire les taux d’intérêt](https://github.com/Guilou001/11-courbe-des-taux) | Tester ce que les taux canadiens permettent de prévoir sur leurs mouvements futurs et les récessions. |
| [12 · Préparer son épargne](https://github.com/Guilou001/12-plan-epargne) | Comparer deux comptes d’épargne canadiens, le REER et le CELI, selon leurs impôts et les rendements possibles. |
| [13 · Mesurer l’effet du dollar américain](https://github.com/Guilou001/13-couverture-de-change) | Acheter des actions américaines depuis le Canada expose aussi aux variations du dollar américain. |
| [14 · Expliquer la performance](https://github.com/Guilou001/14-attribution-performance) | Comprendre pourquoi un portefeuille fait mieux ou moins bien que son plan. |
| [15 · Calculer le prix d’une option](https://github.com/Guilou001/15-valorisation-options) | Une option donne le droit d’acheter ou de vendre plus tard à un prix fixé. |
| [16 · Échanger des hausses futures contre un revenu](https://github.com/Guilou001/16-options-couvertes) | Un fonds peut recevoir un revenu en cédant une partie des hausses futures de ses actions. |
| [17 · Financer les rentes d’un assureur](https://github.com/Guilou001/17-alm-assurance-vie) | Comparer plusieurs façons de choisir des obligations pour payer des rentes pendant des décennies. |
| [18 · Distinguer l’inflation durable des à-coups](https://github.com/Guilou001/18-inflation-fondamentale) | Comparer les mesures canadiennes qui cherchent la tendance générale des prix en atténuant les mouvements extrêmes. |
| [21 · Rejouer une stratégie minute par minute](https://github.com/Guilou001/21-vwap-intrajournalier) | Acheter ou vendre selon la position du prix par rapport à sa moyenne, pondérée par les volumes échangés. |
| [22 · Prévoir la dernière demi-heure](https://github.com/Guilou001/22-derniere-demi-heure) | Vérifier si le mouvement du début de journée annonce celui de la fin. |
| [23 · Comprendre les fonds à levier quotidien](https://github.com/Guilou001/23-fnb-levier-quotidien) | Un fonds qui multiplie chaque mouvement quotidien ne multiplie pas de la même façon le gain de plusieurs années. |
| [24 · Comparer deux sources de prix](https://github.com/Guilou001/24-vwap-iex-vs-consolide) | Comparer les transactions d’une seule bourse à celles du marché américain rassemblé. |
| [25 · Traduire un scénario climatique en pertes de crédit](https://github.com/Guilou001/25-scenario-climatique-bsif) | Refaire l’exemple du régulateur bancaire canadien. |
| [26 · Prévoir la facture d’un assureur](https://github.com/Guilou001/26-provisionnement-iard) | Estimer ce qu’un assureur devra encore payer pour des sinistres déjà survenus. |
| [27 · Mesurer le risque des gros emprunteurs](https://github.com/Guilou001/27-portefeuille-de-credit) | Une banque dépend davantage de quelques clients lorsque leurs prêts concentrent une grande part du montant total. |
| [28 · Lire les comptes autrement](https://github.com/Guilou001/28-etats-financiers-reformules) | Réorganiser les comptes des industries canadiennes pour séparer ce que leur activité rapporte de ce que leur financement ajoute ou retire. |
| [29 · Comprendre la rentabilité des banques](https://github.com/Guilou001/29-rentabilite-des-banques) | Décomposer la rentabilité comptable des six grandes banques canadiennes. |
| [30 · Prévoir le capital contre les fraudes et les erreurs](https://github.com/Guilou001/30-risque-operationnel) | Reconstituer le capital réglementaire lié aux fraudes, erreurs et pannes bancaires à partir des relevés publics. |
| [31 · Chiffrer une garantie de placement](https://github.com/Guilou001/31-fonds-distincts) | Un assureur promet de protéger une partie de la valeur d’un placement. |
| [32 · Mesurer le risque d’un échange d’intérêts](https://github.com/Guilou001/32-xva-swaps) | Deux parties s’échangent des intérêts pendant plusieurs années. |
| [34 · Tester des modèles plus complexes](https://github.com/Guilou001/34-complexite-utile) | Comparer des modèles simples et complexes pour prévoir le marché américain. |
| [35 · Comprendre le désaccord des modèles](https://github.com/Guilou001/35-desaccord-obligations) | Mesurer ce que révèle le désaccord entre six prévisions obligataires. |
| [36 · Apprendre à répartir un portefeuille](https://github.com/Guilou001/36-apprendre-portefeuille) | Apprendre à choisir les placements selon les frais et le degré de prudence de l’investisseur. |
| [37 · Ajouter des placements au portefeuille](https://github.com/Guilou001/37-grands-portefeuilles) | Étudier ce qui arrive quand les placements sont plus nombreux que les mois observés. |
| [38 · Apprendre des autres marchés pour le Canada](https://github.com/Guilou001/38-apprendre-au-canada) | Utiliser quatre marchés étrangers pour prévoir les rendements de stratégies sur actions canadiennes. |
| [39 · Faire comparer les obligations par un modèle](https://github.com/Guilou001/39-attention-obligations) | Faire circuler l’information entre obligations en donnant le même poids à chaque émetteur. |

</details>

<details>
<summary>Ce que les dépôts permettent de vérifier</summary>

| Compétence | Ce qui peut être examiné dans les projets | Dépôts |
|---|---|---|
| Construire et suivre un portefeuille | Comparer les allocations, comptabiliser les frais et expliquer les risques. | [01 · Choisir une répartition](https://github.com/Guilou001/01-frontiere-efficiente) · [02 · Comprendre l’erreur d’estimation](https://github.com/Guilou001/02-erreur-estimation) · [03 · Gérer un portefeuille](https://github.com/Guilou001/03-gestion-portefeuille) · [12 · Préparer son épargne](https://github.com/Guilou001/12-plan-epargne) · [13 · Mesurer l’effet du dollar américain](https://github.com/Guilou001/13-couverture-de-change) · [14 · Expliquer la performance](https://github.com/Guilou001/14-attribution-performance) · [16 · Échanger des hausses futures contre un revenu](https://github.com/Guilou001/16-options-couvertes) · [23 · Comprendre les fonds à levier quotidien](https://github.com/Guilou001/23-fnb-levier-quotidien) · [36 · Apprendre à répartir un portefeuille](https://github.com/Guilou001/36-apprendre-portefeuille) · [37 · Ajouter des placements au portefeuille](https://github.com/Guilou001/37-grands-portefeuilles) |
| Conduire une recherche empirique | Séparer apprentissage et test, comparer des modèles et quantifier l’incertitude. | [04 · Mon mémoire de maîtrise de 2024](https://github.com/Guilou001/04-memoire-uqam-2024) · [05 · Reprendre la question du mémoire](https://github.com/Guilou001/05-memoire-2.0) · [08 · Choisir des actions au Canada](https://github.com/Guilou001/08-facteurs-canada) · [15 · Calculer le prix d’une option](https://github.com/Guilou001/15-valorisation-options) · [21 · Rejouer une stratégie minute par minute](https://github.com/Guilou001/21-vwap-intrajournalier) · [22 · Prévoir la dernière demi-heure](https://github.com/Guilou001/22-derniere-demi-heure) · [24 · Comparer deux sources de prix](https://github.com/Guilou001/24-vwap-iex-vs-consolide) · [34 · Tester des modèles plus complexes](https://github.com/Guilou001/34-complexite-utile) · [35 · Comprendre le désaccord des modèles](https://github.com/Guilou001/35-desaccord-obligations) · [38 · Apprendre des autres marchés pour le Canada](https://github.com/Guilou001/38-apprendre-au-canada) · [39 · Faire comparer les obligations par un modèle](https://github.com/Guilou001/39-attention-obligations) · [Laboratoire de recherche quantitative](https://github.com/Guilou001/quant-research-platform) · [Prévoir une action avec un réseau de neurones](https://github.com/Guilou001/uqam-transformer-actions) |
| Relier les comptes à une décision | Reconstituer les identités comptables et expliquer les hypothèses d’évaluation. | [09 · Évaluer le Canadien National](https://github.com/Guilou001/09-valorisation-entreprise) · [28 · Lire les comptes autrement](https://github.com/Guilou001/28-etats-financiers-reformules) · [29 · Comprendre la rentabilité des banques](https://github.com/Guilou001/29-rentabilite-des-banques) |
| Mesurer le risque de crédit | Vérifier les probabilités de défaut, les pertes et la concentration du portefeuille. | [10 · Étudier un dossier de crédit](https://github.com/Guilou001/10-credit-bancaire) · [27 · Mesurer le risque des gros emprunteurs](https://github.com/Guilou001/27-portefeuille-de-credit) |
| Contrôler les pertes et le capital | Confronter les modèles à des calculs de référence et à des scénarios définis. | [06 · Prévoir les mauvaises journées de Bourse](https://github.com/Guilou001/06-risque-marche) · [25 · Traduire un scénario climatique en pertes de crédit](https://github.com/Guilou001/25-scenario-climatique-bsif) · [30 · Prévoir le capital contre les fraudes et les erreurs](https://github.com/Guilou001/30-risque-operationnel) · [32 · Mesurer le risque d’un échange d’intérêts](https://github.com/Guilou001/32-xva-swaps) |
| Évaluer les engagements d’un assureur | Relier les provisions, les garanties et les placements aux risques à couvrir. | [17 · Financer les rentes d’un assureur](https://github.com/Guilou001/17-alm-assurance-vie) · [26 · Prévoir la facture d’un assureur](https://github.com/Guilou001/26-provisionnement-iard) · [31 · Chiffrer une garantie de placement](https://github.com/Guilou001/31-fonds-distincts) |
| Évaluer une prévision économique | Respecter les dates d’information et confronter les prévisions à des repères simples. | [07 · Estimer la croissance avant sa publication](https://github.com/Guilou001/07-nowcast-pib-canada) · [11 · Lire les taux d’intérêt](https://github.com/Guilou001/11-courbe-des-taux) · [18 · Distinguer l’inflation durable des à-coups](https://github.com/Guilou001/18-inflation-fondamentale) · [Comprendre les cycles de l’économie canadienne](https://github.com/Guilou001/uqam-cycle-economique-canada) · [Comparer neuf modèles sur sept jeux de données](https://github.com/Guilou001/uqam-apprentissage-sept-bases) · [Prévoir le chômage américain](https://github.com/Guilou001/uqam-prevision-facteurs) · [Étudier les effets des taux et des dépenses publiques](https://github.com/Guilou001/uqam-svar-monetaire-budgetaire) · [Vérifier un modèle de croissance](https://github.com/Guilou001/uqam-croissance-capital-humain) |
